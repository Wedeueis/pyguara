...
def configure_game_container() -> DIContainer:
    ...
    win_config = WindowConfig(
        title="Module 5: Physics Integration", screen_width=800, screen_height=600
    )
