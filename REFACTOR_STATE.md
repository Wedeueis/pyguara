...
**Capability gaps (Phase D) → #58** ("replay production layer", sibling of
#37/#40/#43/#46/#51/#55): the recorded `seed` is exposed as `ReplayPlayer.seed` but nothing reseeds
...
Disposition: the BT/FSM authoring gaps → **#46** (sibling of #37/#40/#43);
navmesh funnel/portals/generation → **parked** pending a
...
| `application` | **#68** | ~~no loop pause and no global `time_scale`~~ — **landed in `22c8038`**; what remains is the hit-stop / slow-mo helper built on them (#28), a still-rendering pause, and scripting's scaled waits (#55) | headless "run N seeds"; crash-time autosave → #43 |
...
**Phase D — capability gaps → [#58](https://github.com/Wedeueis/pyguara/issues/58)**
("replay production layer", sibling of #37 / #40 / #43 / #46 / #51 / #55):
...
- *BT/FSM authoring* (**#46**, sibling of #37/#40/#43):
