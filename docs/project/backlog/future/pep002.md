...
1. Fix Game Loop (Fixed Timestep).
2. Optimize ECS (Slots + Tuple Query).
3. Finish ModernGL Rendering Migration.

**Phase 2: The Systems (Weeks 3-4)**

1. Refactor Audio (Spatial + Buses).
2. Implement Asset `.meta` system.
